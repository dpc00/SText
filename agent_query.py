...
_MCP = {
    ...
    "st-plugin": {
        "type": "stdio",
        "command": _PYTHON,
        "args": [r"C:\Users\donal\projects\tools\st_mcp_bridge.py"],
    },
    "screenshot": {
        "type": "stdio",
        "command": "bun",
        "args": ["run", r"C:\Users\donal\tools\screenshot-mcp-fix\src\index.ts"],
    },
    "computer-use": {
        "type": "stdio",
        "command": "npx",
    ...
    "firecrawl": {
        ...
        "env": {"FIRECRAWL_API_KEY": "fc-e55efb6d083142c9818ef12d8cdba306"},
    },
}
...
_ALLOWED_TOOLS = [
    ...
    "mcp__st-plugin__sublime_eval",
    # --- sublime-mcp ---
    "mcp__sublime-mcp__add_folder",
    "mcp__sublime-mcp__close_file",
    "mcp__sublime-mcp__duplicate_line",
    "mcp__sublime-mcp__eval_python",
    "mcp__sublime-mcp__eval_python_latest",
    ...
    "mcp__sublime-mcp__insert_snippet",
    "mcp__sublime-mcp__install_package",
    "mcp__sublime-mcp__lookup_symbol",
    "mcp__sublime-mcp__open_control_panel",
    "mcp__sublime-mcp__open_file",
    "mcp__sublime-mcp__redo",
    "mcp__sublime-mcp__remove_folder",
    "mcp__sublime-mcp__replace_lines",
    "mcp__sublime-mcp__replace_selection",
    "mcp__sublime-mcp__revert_file",
    "mcp__sublime-mcp__run_build",
    "mcp__sublime-mcp__run_command",
    "mcp__sublime-mcp__save_all",
    "mcp__sublime-mcp__save_file",
    "mcp__sublime-mcp__search_packages",
    "mcp__sublime-mcp__select_lines",
    "mcp__sublime-mcp__send_to_view",
    "mcp__sublime-mcp__set_encoding",
    "mcp__sublime-mcp__set_layout",
    "mcp__sublime-mcp__set_setting",
    "mcp__sublime-mcp__set_status",
    "mcp__sublime-mcp__set_syntax",
    "mcp__sublime-mcp__show_panel",
    "mcp__sublime-mcp__sort_lines",
    "mcp__sublime-mcp__str_replace_based_edit_tool",
    "mcp__sublime-mcp__toggle_comment",
    "mcp__sublime-mcp__toggle_sidebar",
    "mcp__sublime-mcp__undo",
    # --- screenshot ---
        ...
        async def handle_client(reader, writer):
            ...
            try:
                ...
                if req.get("type") == "status_request":
                    ...
                    for s in (mcp_status or {}).get("mcpServers", []):
                        ...
                        servers.append({
                            ...
                            "config_url": cfg.get("url", "") or cfg.get("command", ""),
                            "tools": [
                                {
                                    "name": t.get("name", ""),
                                    "description": t.get("description", ""),
                                    "readonly": (t.get("annotations") or {}).get("readOnly", False),
                                    "destructive": (t.get("annotations") or {}).get("destructive", False),
                                }
                                for t in tools
                            ],
                        })
                    cu = ctx_usage or {}
                    categories = [
                        {"name": c.get("name", ""), "tokens": c.get("tokens", 0),
                    ...
                    await send(writer, {"id": qid, "type": "status_data", "servers": servers, "context": ctx})
                    return
                            ...
                            if isinstance(msg, AssistantMessage) and msg.content:
                                ...
                                for block in msg.content:
                                    if isinstance(block, TextBlock) and block.text:
                                        await send(writer, {"id": qid, "type": "text", "text": block.text})
                                    elif isinstance(block, ToolUseBlock):
                                        await send(writer, {
                                            "id": qid, "type": "tool_use",
                                            "tool_id": block.id,
                                            "name": block.name,
                                            "input": block.input,
                                        })
                ...
                async def watch_disconnect():
                    try:
                        await reader.read(1024)  # returns b'' on client disconnect
                    except Exception:
                        pass
