"""
claude_search_app.py -- Search Claude Code conversation history.

Launch via: python claude_search_app.py
Then open:  http://127.0.0.1:5758
Or use the Sublime command: Claude: Search Conversations
"""
